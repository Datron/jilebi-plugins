...
└${border}┘`;
	...
	public processThought(input: SequentialThinkingRequest): MCPResult {
		try {
 ...
 */
function sequential_thinking(request: SequentialThinkingRequest, env: Environment): MCPResult {
	try {
